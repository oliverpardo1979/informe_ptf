...
\begin{frame}{Qué mide la Productividad Total de los Factores}
  ...
  \vspace{0.35cm}
  \begin{block}{Descomposición básica bajo el enfoque de valor agregado}
    \[
...
\begin{frame}{La PTF total terminó por debajo de su nivel de 2004}
...
\begin{frame}{La PTF cayó en 10 de los 21 años observados}
  \idea{Bajo el enfoque de valor agregado, la PTF disminuyó 2,8\% acumulado, equivalente a $-0,14$\% por año.}
...
\begin{frame}{La PTF no evolucionó igual en todas las actividades}
  \idea{El estancamiento de la PTF total oculta trayectorias anuales muy distintas entre las nueve ramas que abarcan toda la economía.}
...
\begin{frame}{Las contribuciones positivas y negativas casi se compensaron}
...
\begin{frame}{El signo de las contribuciones cambió entre subperiodos}
  \idea{Los avances y retrocesos no fueron permanentes ni comunes a todas las ramas.}

  \vspace{0.05cm}
  \begin{center}
    \includegraphics[width=0.96\textwidth,height=0.72\textheight,keepaspectratio]{fig_ptf_contribucion_subperiodos.png}
  \end{center}
\end{frame}

\begin{frame}{Todas las ramas aumentaron su producción}
  \idea{La acumulación de factores e insumos sostuvo el crecimiento, aunque la caída de la PTF contrarrestó parte de ese aporte en cinco ramas.}
...
\begin{frame}{Cinco caídas de PTF borraron las ganancias de cuatro ramas}
...
\begin{frame}{Conclusiones}
  ...
  \vspace{0.30cm}
  \begin{itemize}
    \item La PTF de la economía colombiana estuvo estancada durante las últimas dos décadas.
    \item El resultado total no fue común a toda la economía: la PTF aumentó en cuatro de las nueve ramas y disminuyó en cinco.
    \item Las caídas de la PTF en las actividades financieras, la minería, la manufactura y la construcción restaron 0,38 puntos porcentuales por año al crecimiento de la economía.
    \item Los datos muestran cuánto aportó o restó la PTF de cada rama, pero no establecen por qué aumentó o disminuyó.
    \item Si el país quiere acelerar su crecimiento, debe identificar los obstáculos que explican las caídas de la PTF en esas cuatro actividades.
  \end{itemize}
\end{frame}
